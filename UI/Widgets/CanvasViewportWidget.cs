...
namespace PixelSplashStudio
{
    ...
    public CanvasViewportWidget(CanvasViewport viewport, ToolManager toolManager)
    {
        Bind(viewport, toolManager);
        ConfigureInput();
    ...
    public void Bind(CanvasViewport viewport, ToolManager toolManager)
    {
        if (viewport == null || toolManager == null)
        {
            _viewport = null;
            _toolManager = null;
            SetActiveTool(null);
