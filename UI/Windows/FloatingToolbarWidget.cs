...
{
    class FloatingToolbarWidget : Gtk.Window
    {
        ...
        public FloatingToolbarWidget() : this(UiBuilder.Load("FloatingToolbarWidget.glade"))
        {
        }

        private FloatingToolbarWidget(Builder builder) : base(builder.GetRawOwnedObject("FloatingToolbarWindow"))
        {
